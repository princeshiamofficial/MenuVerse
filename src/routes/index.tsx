  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "restaurant management, QR menu, digital menu, restaurant POS, restaurant analytics, cloud kitchen software",
      },
      {
        property: "og:title",
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          operatingSystem: "Web",
          description:
            "AI-powered restaurant operating platform with QR menus, multi-branch management and live analytics.",
